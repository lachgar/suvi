 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Suivi Projet</a>
            </div>
            <!-- /.navbar-header -->
    ...
    <!-- /#wrapper -->
<!--        <div style="position: relative;top: 24%;left: 25%;font-size: 100px;transform: translateY(-50%);">
            <strong style="font-size: 100px;text-align: center;">page Admin</strong>
        </div>-->
        <!-- jquery -->
        <script src="../../vendor/jquery/jquery.min.js" type="text/javascript"></script>
        <!-- bootstrap JavaScript 4.0.0 -->
        <script src="../../vendor/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="../../vendor/metisMenu/metisMenu.min.css" type="text/javascript"></script>
